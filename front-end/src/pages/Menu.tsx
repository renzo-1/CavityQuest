...
const Menu = () => {
  ...
  return (
    <>
      {show && (
        <div className="z-10 py-8 px-10 absolute w-[50rem] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-myGray rounded-lg z-30">
      ...
      <div className="h-full w-full border flex justify-center items-center space-x-20 relative">
        <div className="w-full h-1/2 absolute top-0 left-0 bg-[url('../../assets/bg2.jpg')] bg-[0rem_-55rem] brightness-75 shadow-lg bg-cover bg-no-repeat "></div>
        <button
